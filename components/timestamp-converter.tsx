...
export function TimestampConverter() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
      <Header
        formatterName={'TimeStamp Converter'}
        icon={<Clock className="sm:h-5 sm:w-5 h-4 w-4 text-blue-600" />} />
          ...
          <main>
            ...
            <Card className="mb-6">
              ...
              <CardContent>
                ...
                <div className="mt-4">
                  <Button onClick={setCurrentTimestamp} className="w-full text-xs text-nowrap">
