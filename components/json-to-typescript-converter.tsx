          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center space-x-2">
                ...
                <h1 className="text-xl font-bold text-gray-900">JSON to TypeScript Converter</h1>
              </div>
            </div>
            <div className="flex items-center space-x-2">
              {isValid ? (
        ...
        <LayoutWithAds adPosition="right" showAds={true}>
          <main>
            ...
            <header className="mb-8">
              <h1 className="text-3xl font-bold text-gray-900 mb-2">JSON to TypeScript Converter</h1>
