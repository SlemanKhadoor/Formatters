          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center space-x-2">
                ...
                <h1 className="text-xl font-bold text-gray-900">JWT Decoder</h1>
              </div>
            </div>
            <div className="flex items-center space-x-2">
              {isValid ? (
                  ...
                  <Tabs defaultValue="about" className="w-full">
                    ...
                    <TabsContent value="about" className="mt-4">
                      <div className="space-y-3 text-sm text-gray-600">
                        <h4 className="font-semibold text-gray-900">What are JWT Tokens?</h4>
                    ...
                    <TabsContent value="structure" className="mt-4">
                      <div className="space-y-3 text-sm text-gray-600">
                        <h4 className="font-semibold text-gray-900">JWT Structure:</h4>
                        <ul className="space-y-2 list-disc list-inside">
                          <li>
                    ...
                    <TabsContent value="security" className="mt-4">
                      <div className="space-y-3 text-sm text-gray-600">
                        <h4 className="font-semibold text-gray-900">Security Notes:</h4>
                        <ul className="space-y-2 list-disc list-inside">
